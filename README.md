...
- **데이터 개요**
  ...
  - 한 개의 비디오 클립은 아래와 같이 구성
    ...
    - 동영상 파일 1개(mp4 포맷)
  - 총 210 개의 비디오 클립 중 70 개 비디오 클립을 해당 저장소에 공개  ( 3개의 참여 업체가 각각 70 개씩 각 저장소에 공개 )
...
- **해당 저장소에 대한 통계** ( 전체 통계는 해당 저장소의 **사람사물추적_최종산출물_객체통계_재검수.xlsx** 파일을 참조 )
...
- 최상위 디렉토리에 비디오 클립명으로 폴더들이 존재

- 각 동영상 클립 폴더 내부에는 **image 폴더**, **json**, **mp4 파일이** 존재함
  ...
  - **Image 폴더**
    ...
    - 해상도는 1920 x 1080(Full HD)

    - 해당 비디오 클립에 대해 15fps 단위로 450 개의 image 파일들이 존재함. 파일명은 **{비디오 클립명}_{시퀀스 아이디}** 형식으로 되어 있음

      - ex) **80608_V0032_000.jpg, 0608_V0032_001.jpg ... 0608_V0032_449.jpg**
...
- **데이터셋은 대용량 다운로드를 고려하여 참여 업체당 1개, 총 3개로 저장소를 분리하였으며, 각 저장소당 70개 씩 총 210개의 비디오 클립이 있음.** 
- **저장소 1 링크: **
- **저장소 2 링크:  **
